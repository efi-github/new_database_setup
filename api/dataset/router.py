...
from api.dataset.schemas import DatasetCreate
...
async def upload_dataset(
    ...
    if extension == "txt":
        file_type = "PlainText"
        temp_dictionary = text_to_json(file_content)
    ...
    add_data_to_db(current_user.username, project_id, temp_dictionary, db)
